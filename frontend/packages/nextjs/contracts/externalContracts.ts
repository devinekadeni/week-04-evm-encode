...
const externalContracts = {
  11155111: {
    Vins0: {
      address: "0x9b7e12ab8325f283d46462960f88ed5c2c9e17b2",
      abi: [
        {
          inputs: [
    ...
    TokenizedBallot: {
      address: "0x616f69ed07e78de543d1de81df0c99b39498f922",
      abi: [
        {
          inputs: [
            { internalType: "bytes32[]", name: "proposalNames", type: "bytes32[]" },
            { internalType: "contract IERC20Token", name: "_tokenContract", type: "address" },
            { internalType: "uint256", name: "_targetBlockNumber", type: "uint256" },
          ],
          stateMutability: "nonpayable",
          type: "constructor",
        },
        {
          ...
          name: "getVotePower",
          outputs: [{ internalType: "uint256", name: "votePower_", type: "uint256" }],
          stateMutability: "view",
          type: "function",
        },
        {
